...
export class TokenService {
   ...
   */
  generateAccessToken(request: Omit<TokenGenerationRequest, 'nonce' | 'userProfile'>): string {
   ...
   */
  private buildIDTokenClaims(userProfile?: UserProfile, scope?: string): Record<string, any> {
    if (!userProfile) {
      return {};
    }
